...
// var PhaserContainer = React.createClass({
    ...
    constructor(){
        ...
        this.keyTimer = 0,
        this.consts = { speed: 200, charW: 20, stageW: 1200,
...
// var Page = React.createClass({
    class Page extends Component {
        state = {hp: 100, atk: 2, item: null, level: 1, nextExp: 100, floor: 1, alertVisible: false, status: "win",
        useMask: true}
	
	
	handleHpChange = (newHp) => {this.setState({ hp: newHp });	}
	handleAtkChange = (newAtk) => {this.setState({ atk: newAtk });	}
	handleItemChange=(newItemName)=>{this.setState({item: newItemName})}
	handleLevelChange=(newLevel)=>{this.setState({ level: newLevel });	}
	handleExpChange=(newExp)=>{this.setState({ nextExp: newExp });	}
	handleFloorChange=(newFloor)=>{this.setState({ floor: newFloor });	}
	handleGameEnd=(isWin)=>{
		if (isWin) {
	...
	handleToggleMask = () =>{ 
        ...
        this.setState({ useMask: !this.state.useMask }); }
